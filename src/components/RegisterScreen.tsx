        ...
        <div className="w-full max-w-sm space-y-8 animate-fade-in">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Usuario"
                  className="h-12 border-sakura-gray-medium focus:border-sakura-red focus:ring-sakura-red/20 rounded-xl"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 border-sakura-gray-medium focus:border-sakura-red focus:ring-sakura-red/20 rounded-xl pr-12"
                    required
                  />
                  <Button
                    type="button"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="h-12 border-sakura-gray-medium hover:bg-blue-50 hover:border-blue-300 rounded-xl"
              >
              ...
              <Button
                variant="outline"
                className="h-12 border-sakura-gray-medium hover:bg-red-50 hover:border-red-300 rounded-xl"
              >
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
